...
import GCPLogo from "@/public/gcp.png";
import DockerLogo from "@/public/docker.png";
import K8sLogo from "@/public/k8s.png";
...
const TechStack = () => {
  return (
    <div className="mx-auto items-center">
      <div className="mx-auto relative flex h-[600px] w-full max-w-[36rem] items-center justify-center overflow-hidden rounded-lg md:shadow-xl">
        ...
        <OrbitingCircles
          className="h-[28px] w-[28px] border-none"
          duration={20}
          delay={15}
          radius={160}
        >
        ...
        <OrbitingCircles
          className="h-[32px] w-[32px] border-none"
          radius={80}
          duration={20}
          delay={7}
          reverse
