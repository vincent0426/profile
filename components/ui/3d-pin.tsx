...
export const PinContainer = ({
  ...
  const [displayPinPerspective, setDisplayPinPerspective] = useState(false);
  ...
  useEffect(() => {
    // Ensure the initial transform is set on the client side
    setTransform("translate(-50%,-50%) rotateX(0deg) scale(1)");
  }, []);
  
  useLayoutEffect(() => {
    setDisplayPinPerspective(true);
  }, []);
